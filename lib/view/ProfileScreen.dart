...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  User _user = User(
      ...
      Name: "",
      Image:
          "https://firebasestorage.googleapis.com/v0/b/appdoctruyentranhonline.appspot.com/o/No-Image-Placeholder.svg.webp?alt=media&token=319ebc86-9ec0-4a16-a877-b477564b212b",
      Email: "",
      Status: false,
      Points: 0,
      IsRead: 0);
    ...
    try {
      ...
      if (doc.exists) {
        ...
        final docDate = DateTime(
            serverTimestamp.year, serverTimestamp.month, serverTimestamp.day);
        setState(() {
            ...
            _buildFunctionButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) =>
                        MyCommentScreen(UserId: widget.userId),
                    transitionsBuilder:
                        (context, animation, secondaryAnimation, child) {
                      const begin = Offset(1.0, 0.0);
                      const end = Offset.zero;
