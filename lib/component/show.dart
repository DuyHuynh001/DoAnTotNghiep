...
class Show extends StatefulWidget {
  final String UserId;
  const Show({super.key, required this.UserId});
...
class _ShowState extends State<Show> {
  ...
  int userLevel = 1;
  User user = User(Id: "", Name: "", Image: "https://firebasestorage.googleapis.com/v0/b/appdoctruyentranhonline.appspot.com/o/No-Image-Placeholder.svg.webp?alt=media&token=319ebc86-9ec0-4a16-a877-b477564b212b", Email: "", Status: false, Points: 0, IsRead: 0);
  @override
  void initState() {
    super.initState();
    _fetchUserData();
  ...
  Future<void> _fetchFollowerCount() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('User').doc(widget.UserId).collection('ViewList').get();
      setState(() {
  ...
  Future<void> _fetchFavoriteCount() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('User').doc(widget.UserId).collection('FavoritesList').get();
      setState(() {
